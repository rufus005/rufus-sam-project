...
const slides: Slide[] = [
  {
    badge: "Premium Shoe Storage Solutions",
    headline: "Premium Shoe",
    highlight: "Storage Solutions",
    subtitle: "We provide high-quality shoe racks designed for durability and maximum capacity. Built to last, made for every home and showroom.",
    cta: "Shop Now",
    ctaLink: "/products",
  ...
  },
  {
    ...
    subtitle: "Our premium double decker shoe rack holds up to 30 pairs — sturdy build, smart design, and easy assembly. Perfect for families and showrooms.",
    cta: "Explore Models",
    ctaLink: "/products",
    secondaryCta: "View Branches",
    secondaryCtaLoggedIn: "View Branches",
    secondaryLink: "/contact",
    secondaryLinkLoggedIn: "/contact",
  ...
  },
  {
    ...
    subtitle: "Choose from 5 rack (30 pairs), 4 rack (24 pairs), 3 rack (18 pairs) and 2 rack (12 pairs) — a perfect fit for every space.",
    cta: "Browse All",
    ctaLink: "/products",
