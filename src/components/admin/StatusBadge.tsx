...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  payment_received: { label: "Payment Received", className: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800" },
